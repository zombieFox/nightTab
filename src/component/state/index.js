...
state.default = {
  ...
  theme: {
    ...
    background: {
      ...
      image: { url: '', blur: 0, grayscale: 0, scale: 100, accent: 0, opacity: 100,inactiveOpacity: 100, vignette: { opacity: 0, start: 90, end: 70 } },
...
state.minMax = {
  ...
  theme: {
    ...
    background: {
      ...
      image: { blur: { min: 0, max: 200 }, grayscale: { min: 0, max: 100 }, scale: { min: 100, max: 400 }, accent: { min: 0, max: 100 }, opacity: { min: 0, max: 100 },inactiveOpacity: { min: 0, max: 100 }, vignette: { opacity: { min: 0, max: 100 }, start: { min: 0, max: 100 }, end: { min: 0, max: 100 } } },
