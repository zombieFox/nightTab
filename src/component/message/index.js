...
message.get = (stringId) => {
  ...
  switch (currentLang) {
    ...
    case 'system':
      ...
      if (browserDetect().chrome && typeof chrome != 'undefined') {
        if ('i18n' in chrome) {
          ...
          string = message.language.pack.en_GB[stringId] ? message.language.pack.en_GB[stringId].message : '';
        }
    ...
    default:
      ...
      if (message.language.pack[currentLang] && stringId in message.language.pack[currentLang]) {
        string = message.language.pack[currentLang][stringId].message;
      } else if (message.language.pack.en_GB && stringId in message.language.pack.en_GB) {
