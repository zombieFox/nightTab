...
export const Control_colorMixer = function ({
  ...
  this.moreControlsToggle = new Button({
    text: message('controlColorMixerMoreControls'),
    iconName: 'arrowKeyboardDown',
    style: ['line'],
    classList: ['collapse-toggle', 'form-group-item-small'],
    title: message('controlColorMixerMoreControls'),
    srOnly: true,
    func: () => {
  ...
  this.colorSliderH = new Control_sliderSlim({
    ...
    path: path + '.hsl.h',
    id: id + '-hsl-h',
    labelText: message('controlColorMixerSliderH'),
  ...
  this.colorSliderS = new Control_sliderSlim({
    ...
    path: path + '.hsl.s',
    id: id + '-hsl-s',
    labelText: message('controlColorMixerSliderS'),
  ...
  this.colorSliderL = new Control_sliderSlim({
    ...
    path: path + '.hsl.l',
    id: id + '-hsl-l',
    labelText: message('controlColorMixerSliderL'),
  ...
  this.colorSliderR = new Control_sliderSlim({
    ...
    path: path + '.rgb.r',
    id: id + '-rgb-r',
    labelText: message('controlColorMixerSliderR'),
  ...
  this.colorSliderG = new Control_sliderSlim({
    ...
    path: path + '.rgb.g',
    id: id + '-rgb-g',
    labelText: message('controlColorMixerSliderG'),
  ...
  this.colorSliderB = new Control_sliderSlim({
    ...
    path: path + '.rgb.b',
    id: id + '-rgb-b',
    labelText: message('controlColorMixerSliderB'),
